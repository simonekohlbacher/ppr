        ...
        return /*html*/ `
          <section class="testimonial contentDiv py-10 relative overflow-hidden">
              <div class="flex flex-col md:flex-row items-center md:items-center justify-between gap-8 relative">
                ...
                <div class="flex flex-col md:justify-start justify-center items-center md:items-start md:basis-1/3 space-y-6 relative z-10">
                ...
                <div class="relative md:basis-2/3 flex items-center w-full mt-[-4rem] md:mt-0">
                    <div class="bg-[#E8E8E8] w-full md:w-[130%] p-6 md:p-8 rounded-l-full md:rounded-l-full rounded-none relative flex flex-col justify-center text-center md:text-left z-0">
                        <!-- Zitatzeichen oben -->
                        <div class="text-[var(--primary-yellow)] text-5xl md:text-8xl font-bold mb-4 leading-none">
                            “
                        </div>
                        <!-- Zitat-Text -->
                        <p class="text-sm md:text-[20px] leading-relaxed mb-6">
                        ...
                        <!-- Unterschrift -->
                        <div class="font-bold text-sm md:text-[20px] text-center md:text-left mt-7">
                            Bernhard Lintner, VP Global QESH<br>
                            Site Director Lenzing, Lenzing AG
                        </div>
                        <!-- Zitatzeichen unten -->
                        <div class="text-[var(--primary-yellow)] text-5xl md:text-8xl font-bold mt-4 self-end">
                            ”
                        </div>
                    </div>
                </div>
